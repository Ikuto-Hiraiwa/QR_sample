...
*/
		...
		$use_user_query = "UPDATE `cats_qr` SET `use_user`=1 WHERE `secret`='".$secret_id."';";
		...
		return '<div align="center"><h2>投票完了しました!</h2></div><br><div align="center"><a href="'.$url.'"><button>トップへ戻る</button></a></div><br><br>';
	}else{
