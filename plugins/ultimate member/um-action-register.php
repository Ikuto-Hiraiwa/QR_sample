	...
	$user_id = wp_insert_user( $userdata );
       ...
       //------------ポイント追加要素---------------//
        ...
        if($user_role=='um_artist_member'){
        	...
        	add_user_meta($user_id , 'artist_last_month_point' , 0);
        	add_user_meta($user_id , 'artist_this_month_point' , 0);
        	add_user_meta($user_id , 'artist_last_month_rank' , '順位無し');
        ...
        if($user_role=='um_fan_member'){
        	...
        	add_user_meta($user_id , 'fan_last_month_rank' , '順位無し');
        	add_user_meta($user_id , 'fan_last_month_point' , 0);
        	add_user_meta($user_id , 'fan_this_month_point' , 0);
